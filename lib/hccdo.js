...
context.size = (function () {
	...
	function card(data,addBleed) {
		...
		if (addBleed && data.blsize > 0) {
			...
			bleedSize = add(bleedSize,bleedSize);//Need it twice.
	...
	function trim(size1,size2) {
		...
		size2 = add(size2,size2); //Need it twice.
...
context.write = (function () {
	...
	function cardStyle(data) {
		...
		var border = (data.border && !data.overlay); //Boolean
		...
		var style = ".card {\n" +
					...
					(paddingSize[0] > 0 ? "\tpadding: " + paddingSize[0] + paddingSize[2] + ";\n" : "") +
		...
		style += ".hccdOverlayBleed {\n" +
					"\tposition: absolute;\n" +
					"\ttop:" + bleedSize[0] + bleedSize[2] + ";\n" +
					"\tleft:" + bleedSize[1] + bleedSize[2] + ";\n" +
					"\theight: " + cardSize[0] + cardSize[2] + ";\n" +
					"\twidth: " + cardSize[1] + cardSize[2] + ";\n" +
		...
		style += ".hccdOverlaySafe {\n" +
					"\tposition: absolute;\n" +
					"\ttop:" + safeSize[0] + safeSize[2] + ";\n" +
					"\tleft:" + safeSize[1] + safeSize[2] + ";\n" +
					"\theight: " + cardSize[0] + cardSize[2] + ";\n" +
					"\twidth: " + cardSize[1] + cardSize[2] + ";\n" +
					"\tborder: 2px dashed red;\n" +
					"}\n";
		style += overlayStyle(cardSize,safeSize,"Safe","2px dashed red",brSize);
		return style;
	}

	function overlayStyle(cardSize,shiftSize,name,borderStyle,radiusSize) {
		var oStyle =  ".hccdOverlay" + name + " {\n" +
					"\tposition: absolute;\n" +
					"\ttop:" + shiftSize[0] + shiftSize[2] + ";\n" +
					"\tleft:" + shiftSize[1] + shiftSize[2] + ";\n" +
					"\theight: " + cardSize[0] + cardSize[2] + ";\n" +
					"\twidth: " + cardSize[1] + cardSize[2] + ";\n" +
					"\tborder: " + borderStyle + ";\n" + 
					"\tborder-radius: " + radiusSize[0] + radiusSize[2] + ";\n" +
					"}\n";
	}
