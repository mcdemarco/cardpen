...
context.size = (function () {
	...
	function convert2in(sizingArray) {
		//Convert from px to inches (for bleed cases),
		...
		if (sizingArray[2] != pxs)
			...
			var newSA = [];
			_.each([0,1],function(idx) {
				newSA[idx] = sizingArray[idx] / parseInt(cardForm.data.dpi,10);
			});
			newSA[2] = ins;
			return newSA;
		}
