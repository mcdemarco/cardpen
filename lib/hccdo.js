...
//Todo: bleed, safety
//      better weird card sizes (including 3" round)
...
(function(context) { 
	...
	var ins = "in";
	var mms = "mm";
	var cardSizes = {poker: [3.5,2.5,ins], //[88.9,63.5] traditional
									 euroPoker: [88,63,mms],
									 bridge: [3.5,2.25,ins],//88,56
									 micro: [1.75,1.25,ins],
									 mini: [2.5,1.75,ins],
									 miniEuro: [67,44,mms], //[2.5,1.625,ins],
									 tarot: [4.75,2.75,ins],
									 usGame: [3.4252,2.20472,ins],
									 ...
									 giant: [7,5,ins],
									 miniSquare: [2,2,ins],
									 smallSquare: [2.5,2.5,ins],
									 square: [2.75,2.75,ins],
									 largeSquare: [3.5,3.5,ins],
									 circle: [3.5,3.5,ins],
									 hex: [3.75,3.25,ins],
									 heart: [3,3.25,ins],
									 tile: [6,6,ins],
...
context.init = (function () {
	...
	function select() {
		...
		_.each(sizes, function(size) {
			...
			var dims = cardSizes[size][1] + cardSizes[size][2] + " x " + cardSizes[size][0] + cardSizes[size][2];
			opt.value = size;
	...
	function start() {
		...
		if (_.isEqual(this.data, exampleForm)) {
			//Show the help.
			context.write.help();
		} else {
...
context.write = (function () {
	...
	function cardStyle() {
		...
		var brSize = context.size.radius();
		var style = ".card {\n" +
