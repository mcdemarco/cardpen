...
// Convert docs
// Set up an auto-running webserver (and a "build" process for the docs, and a cors proxy for bgg).
// add bleed/safe to card size view (too difficult? only selected size?)
// Use html 5 element names instead of classes
// is anything necessary to handle bgg dups?
// cors fix for generating images, and/or proxy flag for templates
// add class and flag to template for html vs. image mode
...
context.write = (function () {
	...
	function formatter(data,cards) {
		...
		var templateB = data.cardClass ? ' {{' + data.cardClass + '}}' : '';
